...
export const STICKER_REGISTRY = [
  ...
  { id: 'event_squad_monthly_gold', name: 'Squad Gold', description: 'Ranked #1 in a monthly squad leaderboard.', category: 'event', rarity: 'legendary', visualId: 'trophy', subVariant: 'gold', color: '#f59e0b', requirement: { type: 'monthly_squad_reward', value: 1 }, evolvesFrom: null, tier: 1 },
  { id: 'event_squad_monthly_silver', name: 'Squad Silver', description: 'Ranked #2 in a monthly squad leaderboard.', category: 'event', rarity: 'epic', visualId: 'trophy', subVariant: 'silver', color: '#94a3b8', requirement: { type: 'monthly_squad_reward', value: 2 }, evolvesFrom: null, tier: 1 },
  { id: 'event_squad_monthly_bronze', name: 'Squad Bronze', description: 'Ranked #3 in a monthly squad leaderboard.', category: 'event', rarity: 'rare', visualId: 'trophy', subVariant: 'bronze', color: '#b45309', requirement: { type: 'monthly_squad_reward', value: 3 }, evolvesFrom: null, tier: 1 },
