...
export const STICKER_REGISTRY = [
  ...
  { id: 'event_squad_monthly_gold', name: 'Apex Crown', description: 'Monthly #1 squad champion. A legendary proof of team momentum.', category: 'event', rarity: 'legendary', visualId: 'trophy', subVariant: 'gold', color: '#f59e0b', requirement: { type: 'monthly_squad_reward', value: 1 }, evolvesFrom: null, tier: 1 },
  { id: 'event_squad_monthly_silver', name: 'Silver Surge', description: 'Monthly #2 squad finisher. Proof your squad stayed in the elite chase.', category: 'event', rarity: 'epic', visualId: 'trophy', subVariant: 'silver', color: '#94a3b8', requirement: { type: 'monthly_squad_reward', value: 2 }, evolvesFrom: null, tier: 1 },
  { id: 'event_squad_monthly_bronze', name: 'Bronze Spark', description: 'Monthly #3 squad finisher. A visible mark of shared consistency.', category: 'event', rarity: 'rare', visualId: 'trophy', subVariant: 'bronze', color: '#b45309', requirement: { type: 'monthly_squad_reward', value: 3 }, evolvesFrom: null, tier: 1 },
