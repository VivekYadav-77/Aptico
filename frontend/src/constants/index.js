...
export const NAV_ITEMS = [
  ...
  { to: '/squad-leaderboard', label: 'Leaderboard', icon: 'leaderboard', description: 'Monthly squad rankings and rewards' },
...
export const SEARCHABLE_INSIGHTS = [
  ...
  { label: 'View squad leaderboard', icon: 'leaderboard', to: '/squad-leaderboard', category: 'Squad' },
