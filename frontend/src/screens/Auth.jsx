...
function GoogleButton({ onError, onSuccess }) {
  ...
  useEffect(() => {
    ...
    const googleIdentityScriptUrl =
      process.env.NEXT_PUBLIC_GOOGLE_IDENTITY_SCRIPT_URL || 'https://accounts.google.com/gsi/client';
  ...
  if (!process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID) {
    return <div className="app-panel-soft text-sm text-[var(--muted-strong)]">Add `NEXT_PUBLIC_GOOGLE_CLIENT_ID` to enable Google sign-in.</div>;
  }
